<template>
    <Content>
      ...
      <Card>
          ...
          <div class="orderBox">
            <Row>
             ...
             <Col span = "18" v-if="orderRealStatus == 1"  class = "btnGroup">
            ...
            <LabelItem label="订单类型" :value="'销售订单'"></LabelItem>
            <LabelItem label="采购商名称" :value="orderDetail.buyerName"></LabelItem>
      ...
      <div class = "btnGroup">
          <Button type="text" v-if="orderRealStatus == 1 || orderRealStatus == 2"  @click = "orderCancel">取消订单</Button>
          <Button type="text" v-if="orderRealStatus == 1"  @click = "orderConfirm">确认订单</Button>
          <Button type="text" v-if="orderRealStatus == 5"  @click = "orderDelivery">确认发货</Button>
          <Button type="text" v-if="orderRealStatus == 8"  @click = "orderFinish">确认完成</Button>
          <Button type="text" v-if="orderRealStatus == 8"  @click = "orderRefuse">拒绝完成</Button>
          <Button type="text" v-if="orderRealStatus == 1"  @click = "handleOrderEdit">确认编辑</Button>
      ...
      // 获取订单详情
          getOrderDetail () {
              Util.ajax.post('/order.order/detail', {
                  ...
                  // 读取订单详情数据
                  this.orderDetail.buyerName = resp.buyer_info.fullname;
                  ...
                  if(resp.real_status == 10) {
                      ...
                      switch(resp.real_status) {
                          case 1:
                              this.orderStep[0].content = '买方已提交订单，等待您确认'
                              this.orderStatus = 0
                          break;
                          case 2:
                              this.orderStep[0].content = '您已修改订单，等待卖方确认'
                              this.orderStatus = 0
                          break;
                          case 3:
                          ...
                          break;
                          case 4:
                              this.orderStep[2].content = '买方已支付订单，等待收款'
                              this.orderStatus = 2
                          break;
                          case 5:
                              this.orderStep[3].content = '您已确认收款，等待发货'
                              this.orderStatus = 3
                          break;
                          case 6:
                          ...
                          break;
                          case 7:
                              this.orderStep[4].content = '您已发货，买家等待收货中'
                              this.orderStatus = 4
                          break;
                          case 8:
                              this.orderStep[4].content = '买家已确认收货，等待您完成'
                              this.orderStatus = 4
                          break;
                          case 9:
                      ...
                      switch(resp.real_status) {
                          ...
                          break;
                          case 7:
                              this.orderStep[3].content = '您已发货，等待买家收货'
                              this.orderStatus = 3
                          break;
                          case 8:
                              this.orderStep[3].content = '买家已确认收货，等待您完成'
                              this.orderStatus = 3
                          break;
                          case 9:
        ...
        // 返回采购订单列表
        goThere () {
            this.$router.push({name: 'order_seller'})
        },
        // 弹窗选择商品返回的数据
