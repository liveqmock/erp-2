<template>
    <Content style="margin: 20px auto;">
        <Form :model="formItem" ref="form" label-position="right" :label-width="120" :rules="ruleValidate">
            ...
            <FormItem label="图册" prop="imgs">
             
                 <div class="demo-upload-list"  v-for="item in formItem.imgs">
                    ...
                    <template>
                        ...
                        <Progress v-if="imgurl.showProgress" :percent="imgurl.percentage" hide-info></Progress>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleRemove(file) {
                const fileList = this.formItem.imgs;
                this.formItem.imgs.splice(fileList.indexOf(file), 1);
            },
            handleSuccess(res, file) {
                 file.url = res.result.url;
                 file.name = res.result.url;
                 this.formItem.imgs.push( res.result.url)
            },
         ...
         mounted() {
            ...
            this.formItem.unit= this.formItem.unit+'';
