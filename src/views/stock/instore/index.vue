...
<template>
    <Content>
        <Row class="margin-bottom-10">
            <Col span="24">
            <Button type="primary" @click="add">创建入库单</Button>
            </Col>
        </Row>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 创建入库单弹窗
            add() {
                this.$router.push('/stock/instore/add');
            },
            // 确认出库单弹窗
            confirmStock(params) {
                this.$router.push({path: '/stock/instore/add', query: {store_code: params.row.store_code}});
            },
        },
        created () {
